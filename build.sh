...
go build -o build/darwin/trigram_$VER -ldflags="-X main.commit=${GIT_COMMIT}"
env GOOS=linux GOARCH=amd64 go build -o build/linux/trigram_$VER -ldflags="-X main.commit=${GIT_COMMIT}"
